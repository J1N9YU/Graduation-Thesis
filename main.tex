...
\etitle{Spin coating TPB film on acrylics and measurement of its wavelength shifting efficiency}%英文论文题目
\author{杨航}%作者
\authorx{杨\ 航\ }%封面上作者（各字符间可加空白）
\date{二〇二〇年五月}%完成日期
\studentid{16349049}%学号
\school{物理学院}%院（系）
\major{物理学}%专业
\mentor{唐建}%指导老师
...
\ekeywords{Wavelength shifter, Tetraphenyl butadiene, Spin coating method}%英文关键词
